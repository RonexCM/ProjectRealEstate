                ...
                <div class="row">
					...
					<div class="col-lg-8">
                        <div class="row">
							...
							<?php 
							$query=mysqli_query($con,"SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid AND approvalStatus = 'Approved' AND status = 'available'");
                    ...
                    <div class="col-lg-4">
                        ...
                        <ul class="property_list_widget">
                            ...
                            <?php 
                            $query=mysqli_query($con,"SELECT * FROM `property` WHERE isFeatured = 1 AND approvalStatus = 'Approved' ORDER BY date DESC LIMIT 3");
                                    while($row=mysqli_fetch_array($query))
                                    {
                            ?>
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget"><!-- FOR MORE PROJECTS visit: codeastro.com -->
								...
								<?php 
								$query=mysqli_query($con,"SELECT * FROM `property` WHERE approvalStatus = 'Approved' ORDER BY date DESC LIMIT 6");
										while($row=mysqli_fetch_array($query))
										{
								?>
                                <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
