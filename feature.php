					...
					<table class="items-list col-lg-12 table-hover" style="border-collapse:inherit;">
                        <thead>
                             <tr  class="bg-dark">
                                ...
                                <th class="text-white font-weight-bolder" style="width:25px;">Approval Status</th>
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
                            ...
                            <tr>
                                ...
                                <td class="text-capitalize"><?php echo $row['approvalStatus'];?></td>
								<td class="text-capitalize"><?php echo $row['24'];?></td>
                                <td><?php if($row['approvalStatus']=='Approved'){?><a class="btn btn-info" href="submitpropertyupdate.php?id=<?php echo $row['0'];?>">Update</a><?php }elseif($row['approvalStatus']=='Pending'){?><a class="btn btn-danger" href="submitpropertydelete.php?id=<?php echo $row['0'];?>">Delete</a><?php } ?></td>
                            </tr>
							<?php } ?>
							<!-- FOR MORE PROJECTS visit: codeastro.com -->
                        </tbody>
